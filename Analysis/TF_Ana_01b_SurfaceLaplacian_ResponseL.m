...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                %
% Adaptive Control Frequency Analysis ResponseL  %                               
...
dirs.oldhome                 = 'E:\AdaptiveControl\Data\FrequencyData\'; % where I saved the stimulus locked data
...
for sub = 2:Part_N
    ...
    fileID                       = strcat(Participant_IDs{sub}, '_epoched_freq_ResponseL.set'); %get file ID
    ...
    % save data
    EEG = pop_saveset(EEG, 'filename',  strcat(Participant_IDs{sub}, '_epoched_freq_SLplc_ResponseL'),'filepath',[folderID]); 
end