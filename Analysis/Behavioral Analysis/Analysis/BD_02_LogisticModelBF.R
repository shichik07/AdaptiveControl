...
load("C:/Users/doex9445/Dateien/Julius/AdaptiveControl/Data/fit_logisticMod_inducer_LW.rda")
load("C:/Users/doex9445/Dateien/Julius/AdaptiveControl/Data/fit_logisticMod_inducer_IS.rda")
ind_sum_LW <- summary(fit_logisticMod_inducer_LW)
ind_sum_IS <- summary(fit_logisticMod_inducer_IS)
...
for(mods in 1:length(LW_mods)){
  ...
  # get save name for variable
  save_name <- paste("fit_diagnostic_", LW_mods[mods], ".rda", sep = "")
  # fit the model
...
for(mods in 1:length(IS_mods)){
  ...
  # get save name for variable
  save_name <- paste("fit_diagnostic_", IS_mods[mods], ".rda", sep = "")
  # fit the model
