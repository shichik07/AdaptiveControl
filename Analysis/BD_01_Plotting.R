...
Control_eff <- ggplot(data = Conditional_posterior, aes(y = Plot_type, x = Mean_RT)) +
  ...
  labs(x= "RT in ms", y = "Measure", fill = "Item Type", fill_ramp = "Interval") +
  ggtitle("Conditional Mean Effect Estimates in ms") + 
  theme(
